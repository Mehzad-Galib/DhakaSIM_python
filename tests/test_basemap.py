...
class AnchorTest(unittest.TestCase):
    ...
    def test_network_without_a_centre_has_no_georeference(self):
        # demo_backup is the synthetic network from the paper. It is nowhere.
        links, nodes = basemap.read_network("demo_backup")
        self.assertIsNone(basemap.georeference("demo_backup", links, nodes))
...
class PlacementTest(unittest.TestCase):
    ...
    def test_unplaceable_network_gives_no_basemap(self):
        links, nodes = basemap.read_network("demo_backup")
        self.assertIsNone(basemap.BaseMap.load("demo_backup", links, nodes))
